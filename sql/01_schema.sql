...
CREATE TABLE fact_incident (
    ...
    FOREIGN KEY (occurred_date_id)
        REFERENCES dim_date(date_id),

    FOREIGN KEY (reported_date_id)
        REFERENCES dim_date(date_id),

    FOREIGN KEY (crime_type_id)
        REFERENCES dim_crime_type(crime_type_id),

    FOREIGN KEY (disposition_id)
        REFERENCES dim_disposition(disposition_id),
...
CREATE TABLE fact_arrest (
    ...
    FOREIGN KEY (arrest_date_id)
        REFERENCES dim_date(date_id),

    FOREIGN KEY (demographic_id)
        REFERENCES dim_demographic(demographic_id),

    FOREIGN KEY (charge_category_id)
        REFERENCES dim_charge_category(charge_category_id)
);
...
CREATE INDEX idx_fact_incident_source_year
ON fact_incident(source_year);
...
CREATE INDEX idx_fact_arrest_source_year
ON fact_arrest(source_year);